...
[Middleware](/oss/langchain/middleware) provides extensibility for customizing agent behavior at different stages of execution—adding tools, modifying context, handling errors, or implementing guardrails. See [Middleware](/oss/langchain/middleware) for the full API.
