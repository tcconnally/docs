...
<Note>
Many capabilities below (summarization, memory, skills, subagents) require a filesystem backend to store and retrieve data. Add @[`FilesystemMiddleware`] to your stack to enable them. See [Backends](/oss/deepagents/backends).
</Note>
