...
`@langchain/quickjs` ships with prebuilt libraries that you can add to any agent. See [Prebuilt libraries](/oss/deepagents/pre-built-libraries) for setup and API reference.
