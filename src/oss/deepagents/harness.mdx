...
See [Multimodal content](/oss/deepagents/multimodal) for end-to-end examples covering user input, `read_file`, and multimodal tool returns.
...
- **[Compression](/oss/deepagents/context-engineering#context-compression)** — Built-in offloading and summarization keep context within window limits as tasks progress, and you can replace either layer with custom middleware
...
For configuration details, see [Context engineering](/oss/deepagents/context-engineering). For how to tune, replace, or rewrite compression yourself, see [Replace or customize compression](/oss/deepagents/context-engineering#replace-or-customize-compression).
