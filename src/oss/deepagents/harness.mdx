...
|-----------|-----------------|
| **[Execution environment](#execution-environment)** | Virtual filesystem, optional sandbox, and REPL (interpreter) |
| **[Context management](#context-management)** | Skills, memory, summarization, context offloading, and prompt caching |
| **[Delegation](#delegation)** | Subagent spawning and task planning |
| **[Steering](#steering)** | Human-in-the-loop approval and interrupts |
...
The execution environment component gives agents a place to read, write, and run code. It has three layers:
