...
:::python
@[`create_deep_agent`] is @[`create_agent`] plus a pre-assembled middleware stack. These parameters configure each layer.
...
:::js
`createDeepAgent` is `createAgent` plus a pre-assembled middleware stack. These parameters configure each layer.
