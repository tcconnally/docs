...
For the full parameter list, see the @[`create_deep_agent`] API reference. To compose a fully custom harness from scratch, see [Agent harness](/oss/langchain/harness).
:::
...
For the full parameter list, see the [`createDeepAgent`](https://reference.langchain.com/javascript/deepagents/types/CreateDeepAgentParams) API reference. To compose a fully custom harness from scratch, see [Agent harness](/oss/langchain/harness).
:::
