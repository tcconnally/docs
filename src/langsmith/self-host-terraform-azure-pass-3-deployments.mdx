...
Pass 3 enables [LangSmith Deployment](/langsmith/deploy-self-hosted-full-platform), which lets you deploy and manage LangGraph graphs as API servers directly from the LangSmith UI. Three new pods are added to the cluster.
