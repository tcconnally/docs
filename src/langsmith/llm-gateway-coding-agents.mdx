...
Authentication uses your organization's centralized Anthropic API key from workspace secrets, not individual developer subscriptions. To route individual subscription users through the gateway, contact your LangChain support team.
