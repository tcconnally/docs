...
Pass 4 enables Agent Builder, which provides visual AI-assisted creation and management of LangGraph agents from the LangSmith UI. No `terraform apply` is needed for this pass; it only requires `make init-values && make deploy`.
