...
description: Provision the AKS cluster, VNet, PostgreSQL, Redis, Blob Storage, Key Vault, cert-manager, and KEDA via Terraform.
---

Pass 1 creates all Azure infrastructure. No LangSmith workloads are deployed yet—that happens in [Pass 2](/langsmith/self-host-terraform-azure-pass-2-langsmith).
