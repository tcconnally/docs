...
<Tip>
For dynamic model selection at runtime, see [Dynamic model selection](/oss/javascript/langchain/models#dynamic-model-selection).
</Tip>
...
<Tip>
For dynamic tool selection and runtime tool registration, see [Dynamic tool selection](/oss/javascript/langchain/tools#dynamic-tool-selection).
</Tip>
