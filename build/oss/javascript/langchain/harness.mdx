...
| **Filesystem**—files persisted across turns | [`FilesystemMiddleware`](https://reference.langchain.com/javascript/deepagents/middleware/createFilesystemMiddleware) | ✓ |
