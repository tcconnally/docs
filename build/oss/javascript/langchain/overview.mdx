...
<Tip>
**LangChain vs. Deep Agents vs. LangGraph**

[Deep Agents](/oss/javascript/deepagents/overview/) (`create_deep_agent`) pre-assembles a production-ready harness on top of LangChain: filesystem, summarization, subagents, and prompt caching included by default. Start here when you want common patterns pre-built.

[LangChain](/oss/javascript/langchain/agents) gives you `create_agent` — a minimal harness you configure and extend with middleware. Full control, composable primitives, take exactly what your use case needs.

[LangGraph](/oss/javascript/langgraph/overview) is our low-level orchestration runtime for advanced workflows combining deterministic and agentic steps.

[LangSmith](/langsmith/home) traces, debugs, and evaluates agents built with any of the above.
</Tip>
