...
| 💬 `respond`  | Return the human's message directly as the tool result, skipping execution, for "ask user" style tools. | Answer an `"ask_user"` prompt with a direct reply |
