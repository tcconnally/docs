...
We think of `deepagents` as an ["agent harness"](/oss/javascript/concepts/products#agent-harnesses-like-the-deep-agents-sdk). It is the same core tool calling loop as other agent frameworks, but with built-in tools and capabilities organized into four components:

| Component | What it provides |
|-----------|-----------------|
| **[Execution environment](/oss/javascript/deepagents/harness#execution-environment)** | Virtual filesystem, optional sandbox, and REPL (interpreter) |
| **[Context management](/oss/javascript/deepagents/harness#context-management)** | Skills, memory, summarization, context offloading, and prompt caching |
| **[Delegation](/oss/javascript/deepagents/harness#delegation)** | Subagent spawning and task planning |
| **[Steering](/oss/javascript/deepagents/harness#steering)** | Human-in-the-loop approval and interrupts |
