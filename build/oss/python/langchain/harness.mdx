...
- **Arguments to `create_agent`** — `tools=` and `system_prompt=` wire in static capabilities directly.
...
| **Filesystem**—files persisted across turns | [`FilesystemMiddleware`](https://reference.langchain.com/python/deepagents/middleware/filesystem/FilesystemMiddleware) | ✓ |
...
| **Tool filtering**—trims tool list per model call | [`LLMToolSelectorMiddleware`](https://reference.langchain.com/python/langchain/agents/middleware/tool_selection/LLMToolSelectorMiddleware) | — |
