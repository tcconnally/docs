...
[Deep Agents](/oss/python/deepagents/overview/) (`create_deep_agent`) pre-assembles a production-ready harness on top of LangChain: filesystem, summarization, subagents, and prompt caching included by default. Start here when you want common patterns prebuilt.
