...
<CardGroup cols={2}>
  <Card title="Execution environment" icon="bolt" href="/oss/python/deepagents/harness#execution-environment">
    Tools, virtual filesystem, optional sandbox, and REPL (interpreter)
  </Card>
  <Card title="Context management" icon="database" href="/oss/python/deepagents/harness#context-management">
    Skills, memory, summarization, context offloading, and prompt caching
  </Card>
  <Card title="Delegation" icon="sitemap" href="/oss/python/deepagents/harness#delegation">
    Subagent spawning and task planning
  </Card>
  <Card title="Steering" icon="user" href="/oss/python/deepagents/harness#steering">
