...
`create_deep_agent` pre-assembles a middleware stack on top of [`create_agent`][langchain.agents.create_agent]. To build a fully custom agent—choosing exactly which capabilities to include—see [Agent harness](/oss/python/langchain/harness).
