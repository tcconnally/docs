...
[`create_deep_agent`](https://reference.langchain.com/python/deepagents/graph/create_deep_agent) is [`create_agent`](https://reference.langchain.com/python/langchain/agents/factory/create_agent) plus a pre-assembled middleware stack. These parameters configure each layer.
...
To compose a fully custom harness from scratch, see [Agent harness](/oss/python/langchain/harness).
