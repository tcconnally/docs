...
description: "Integrate with the TavilySearchAPIRetriever retriever using LangChain Python."
---

<Note>
For new projects, we recommend the [TavilySearch](/oss/python/integrations/tools/tavily_search) tool in the `langchain-tavily` package. This retriever still works but is part of the legacy `langchain-community` package.
</Note>
